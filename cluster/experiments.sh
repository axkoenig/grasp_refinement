...
for i in $(seq 1 $NUM_EXPERIMENTS); do
    ...
    submit_job "1" ${i} "sac" "1" "10000" "0.0001" "0.001"
    submit_job "2" ${i} "sac" "1" "10000" "0.0001" "0.001"
    submit_job "3" ${i} "sac" "1" "10000" "0.0001" "0.001"
    submit_job "4" ${i} "sac" "1" "10000" "0.0001" "0.001"

    submit_job "1" ${i} "sac" "2" "10000" "0.0001" "0.001"
    submit_job "1" ${i} "sac" "3" "10000" "0.0001" "0.001"
    submit_job "1" ${i} "sac" "4" "10000" "0.0001" "0.001"
done
