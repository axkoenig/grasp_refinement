...
for r in range(0, rows):
    for c in range(0, cols):
        ...
        if len(row_id) == 0:
            print(f"Oops, looks like there is no final_state for the combination {cur_x_rows}, {cur_y_rows}. Probably you stopped the experiment early.")
            z[r, c] = -2
        else:
