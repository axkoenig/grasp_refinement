...
public:
  ...
  {
    preshape_1_cmd_pub = nh->advertise<Float64>("/lbr4_reflex/preshape_j1_effort_controller/command", 1);
    preshape_2_cmd_pub = nh->advertise<Float64>("/lbr4_reflex/preshape_j2_effort_controller/command", 1);
    proximal_1_cmd_pub = nh->advertise<Float64>("/lbr4_reflex/proximal_j1_effort_controller/command", 1);
    proximal_2_cmd_pub = nh->advertise<Float64>("/lbr4_reflex/proximal_j2_effort_controller/command", 1);
    proximal_3_cmd_pub = nh->advertise<Float64>("/lbr4_reflex/proximal_j3_effort_controller/command", 1);
